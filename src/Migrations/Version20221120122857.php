 ...
 */
final class Version20221120122857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE config (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, value VARCHAR(500) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE date_log (id INT AUTO_INCREMENT NOT NULL, employee_code_id INT NOT NULL, date DATE NOT NULL, type VARCHAR(40) NOT NULL, note LONGTEXT DEFAULT NULL, total_minutes INT DEFAULT NULL, INDEX IDX_3E332FB0A796A818 (employee_code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, employee_code VARCHAR(100) NOT NULL, name VARCHAR(255) NOT NULL, department VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE time_track (id INT AUTO_INCREMENT NOT NULL, employee_code_id INT NOT NULL, date DATE NOT NULL, time_log INT DEFAULT NULL, INDEX IDX_939119DAA796A818 (employee_code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE date_log ADD CONSTRAINT FK_3E332FB0A796A818 FOREIGN KEY (employee_code_id) REFERENCES employee (id)');
        ...
        $this->addSql('ALTER TABLE time_track ADD CONSTRAINT FK_939119DAA796A818 FOREIGN KEY (employee_code_id) REFERENCES employee (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE date_log DROP FOREIGN KEY FK_3E332FB0A796A818');
        $this->addSql('ALTER TABLE time_track DROP FOREIGN KEY FK_939119DAA796A818');
        ...
        $this->addSql('DROP TABLE date_log');
